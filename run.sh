...
docker run -it -p 8101:8101 -p 8181:8181 -d --name fuse.local --link nexus.local:nexus --link auth.service:auth --link customer.service:customer --link customer.db:postgres eurotrip11/jboss-fuse
